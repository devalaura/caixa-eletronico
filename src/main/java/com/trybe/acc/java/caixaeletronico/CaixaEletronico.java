...
public class CaixaEletronico {
  ...
  public static void main(String[] args) {
    ...
    Conta contaPoupancaPessoaCliente1 = new Conta("Poupança", pessoaCliente1, banco);
    Conta contaCorrentePessoaCliente1 = new Conta("Corrente", pessoaCliente1, banco);
    banco.adicionarConta(contaPoupancaPessoaCliente1);
    banco.adicionarConta(contaCorrentePessoaCliente1);

    // pessoa cliente 2
    PessoaCliente pessoaCliente2 = banco.adicionarPessoaCliente(
        "Abadiania Silva", "848.725.510-87", "1234");
    Conta contaPoupancaPessoaCliente2 = new Conta("Poupança", pessoaCliente2, banco);
    Conta contaCorrentePessoaCliente2 = new Conta("Corrente", pessoaCliente2, banco);
    banco.adicionarConta(contaPoupancaPessoaCliente2);
    banco.adicionarConta(contaCorrentePessoaCliente2);

    // pessoa cliente 3
    PessoaCliente pessoaCliente3 = banco.adicionarPessoaCliente(
        "Camaragibe Oliveira", "433.892.200-11", "1234");
    Conta contaPoupancaPessoaCliente3 = new Conta("Poupança", pessoaCliente3, banco);
    Conta contaCorrentePessoaCliente3 = new Conta("Corrente", pessoaCliente3, banco);
    banco.adicionarConta(contaPoupancaPessoaCliente3);
    banco.adicionarConta(contaCorrentePessoaCliente3);
    // laco infinito
    while (true) {
